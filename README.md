...
🟢🟢🟢🟢🟢 Todos LEDs verdes → cofre aberto por 5 segundos
...
- Botões “tremem” (bounce) → múltiplos pulsos indesejados
- Dois botões juntos → comportamento indefinido (ao pressionar mais de um botão simultaneamente)
- Botões ignorados durante 3s e 5s
- Contador depende do clock
- Cliques muito rápidos podem não ser detectados
- Hardware e simulação podem se comportar diferente
